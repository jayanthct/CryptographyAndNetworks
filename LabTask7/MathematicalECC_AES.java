...
public class MathematicalECC_AES {
    public static void main(String[] args) {
        ...
        ECCCurve curve2 = new ECCCurve(
                new BigInteger("-3"),                  // a
                new BigInteger("2455155546008943817740293915197451784769108058161191238065"), // b
                new BigInteger("6277101735386680763835789423207666416083908700390324961279")  // p
        );
