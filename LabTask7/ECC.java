...
public class ECC {
        ...
        private static final BigInteger P = new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F", 16); // Prime field
        ...
        private static final BigInteger Gx = new BigInteger("79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798", 16); // Base point x
        private static final BigInteger Gy = new BigInteger("483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8", 16); // Base point y
        private static final BigInteger N = new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", 16); // Order of G
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Shared Secret (Alice): (" + sharedSecretA.x.toString(16) + ", " + sharedSecretA.y.toString(16) + ")");
            System.out.println("Shared Secret (Bob): (" + sharedSecretB.x.toString(16) + ", " + sharedSecretB.y.toString(16) + ")");
        }
    }
